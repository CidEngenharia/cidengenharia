...
export const translations = {
  PT: {
    ...
    accessLabel: 'Acessar',
    portalNames: ['CidDesenvolvimento', 'CidVisual', 'CidManutenção'],
    portalServices: [
  ...
  EN: {
    ...
    accessLabel: 'Access',
    portalNames: ['CidDevelopment', 'CidVisual', 'CidMaintenance'],
    portalServices: [
  ...
  ES: {
    ...
    accessLabel: 'Acceder',
    portalNames: ['CidDesarrollo', 'CidVisual', 'CidMantenimiento'],
    portalServices: [
