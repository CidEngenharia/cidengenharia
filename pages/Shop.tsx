...
const AppCard: React.FC<{
  ...
  return (
    <Link
      to={isComingSoon || isExternal ? '#' : path}
      onClick={handleClick}
...
export const Shop: React.FC = () => {
  const apps = [
    {
      ...
      desc: "Networking inteligente com NFC e QR Code profissional.",
      icon: "qr_code_2",
      path: "/digital-card",
    ...
    {
      title: "CondosMarTI",
      desc: "Editor premium de artes gráficas e convites inteligentes.",
      icon: "auto_fix_high",
      path: "https://condosmart.vercel.app/",
      color: "from-rose-500 to-pink-600",
      tag: "DESIGN"
    },
    {
      title: "AuditPro",
      desc: "Auditoria profunda de sites para performance e SEO técnico.",
      icon: "fact_check",
      path: "https://auditproultra.vercel.app/",
      color: "from-blue-500 to-cyan-600",
      tag: "ANALYTICS"
    },
    {
      title: "Rede365",
      desc: "Hub estratégico para autônomos e microempreendedores.",
      icon: "hub",
      path: "#",
    ...
    {
      title: "LectioEquilibrium",
      desc: "Plataforma de curadoria e conhecimento individual equilibrado.",
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-[#020617] p-6 md:p-12 lg:p-20 transition-colors duration-500">
      ...
      {/* App Grid */}
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
        {apps.map((app, idx) => (
          <motion.div
            key={idx}
        ...
        <div className="p-10 md:p-14 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/60 rounded-[3rem] shadow-xl relative overflow-hidden group">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-xs max-w-lg mx-auto leading-relaxed">
              Desenvolvemos soluções modulares personalizadas para automatizar os desafios únicos do seu negócio ou crescimento pessoal.
            </p>
