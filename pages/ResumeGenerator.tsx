...
export const ResumeGenerator: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto font-roboto pb-20">
      <nav className="flex items-center gap-4 text-xs font-black uppercase tracking-widest text-slate-400 mb-8 px-6">
        ...
        <span>|</span>
        <button onClick={() => navigate(-1)} className="flex items-center gap-1 hover:text-primary-500 transition-colors">
